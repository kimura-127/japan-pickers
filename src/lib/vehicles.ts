...
export const vehicles: Vehicle[] = [
  {
    ...
    detailedFeatures: [
      ...
      },
      {
        icon: "shower-head",
        name: "シャワー/トイレ",
        description: "プライベートな空間で快適に使えるカセットトイレを完備。",
      },
      {
        icon: "thermometer",
        name: "エアコン/暖房",
      ...
      },
      {
        ...
        name: "運転のしやすさ",
        description:
          "オートマ車、バックカメラ、レカロシートを装備し、長距離の運転も快適に。2017年3月12日以降に普通免許を取得した方は準中型免許が必要です。",
      },
      {
        icon: "pet",
        name: "特別会員のみペット可能",
    ...
    equipment: {
      ...
      bathroom: ["外部温水シャワー", "電気ラジエター温水器", "カセットトイレ", "洗面台"],
      bedroom: ["ダブルベッド × 2", "展開シングルベッド × 1", "収納スペース多数"],
      climate: [
        "ルーフエアコン",
        "ルーフベンチレーター×2",
        "リヤクーラー/ヒーター",
  ...
  },
  {
    ...
    images: [
      ...
      { src: "/images/camload/IMG_9026.JPG", alt: "カムロードZiL 外観", type: "exterior" },
      { src: "/images/camload/IMG_9024.JPG", alt: "カムロードZiL 外観", type: "exterior" },
      { src: "/images/camload/aboutcar_zil_01.jpg", alt: "カムロードZiL 内装", type: "interior" },
      { src: "/images/camload/aboutcar_zil_02.jpg", alt: "カムロードZiL 内装", type: "interior" },
      { src: "/images/camload/aboutcar_zil_03.jpg", alt: "カムロードZiL 内装", type: "interior" },
      { src: "/images/camload/aboutcar_zil_04.jpg", alt: "カムロードZiL 内装", type: "interior" },
      { src: "/images/camload/aboutcar_zil_05.jpg", alt: "カムロードZiL 内装", type: "interior" },
      { src: "/images/camload/aboutcar_zil_06.jpg", alt: "カムロードZiL 内装", type: "interior" },
      { src: "/images/camload/aboutcar_zil_07.jpg", alt: "カムロードZiL 内装", type: "interior" },
      { src: "/images/camload/aboutcar_zil_08.jpg", alt: "カムロードZiL 内装", type: "interior" },
      { src: "/images/camload/aboutcar_zil_09.jpg", alt: "カムロードZiL 内装", type: "interior" },
      { src: "/images/camload/aboutcar_zil_10.jpg", alt: "カムロードZiL 内装", type: "interior" },
    ],
    capacity: 10,
  ...
  },
  {
    ...
    equipment: {
      ...
      outdoor: ["4.5Mサイドオーニング", "アウトドアテーブル＆チェア", "2台積みサイクルキャリア"],
